<%@ Page Title="Remind : ระบบการแจ้งเตือน" Language="vb" AutoEventWireup="false" MasterPageFile="~/site.Master" CodeBehind="RemindUpdateDue.aspx.vb" Inherits="PTECCENTER.FrmRemindUpdateDue" %>
                                 ...
                                 <AlternatingRowStyle BackColor="#CCCCFF" />
                                      <Columns>
	                                    ...
	                                    <asp:TemplateField HeaderText="Actived" >
		                                    <ItemTemplate>
			                                    <asp:checkbox id="lblChk" runat="server" checked='<%#Eval("ch")%>' ></asp:checkbox>
		                                    </ItemTemplate>
	                                    </asp:TemplateField>
