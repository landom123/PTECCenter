                    ...
                    <div class="table-responsive overflow-auto" style="font-size: 0.9rem">
                        <asp:GridView ID="gvRemind"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="Code_ref" HeaderText="เลขที่อ้างอิง" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcoderef" runat="server" Text='<%#Eval("Code_ref")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField SortExpression="Vendor_Code" HeaderText="ผู้รับเงิน" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBranch" runat="server" Text='<%#Eval("Vendor_Code")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="Pay_by" HeaderText="จ่ายโดย" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
