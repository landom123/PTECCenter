...
Imports System.IO
Public Class FrmRemindUpdateDue
    ...
    Private Sub gvData_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvRemind.RowDataBound
        '*** remindid ***'
        ...
        End If
        '*** chk ***'
        Dim lblChk As CheckBox = CType(e.Row.FindControl("lblChk"), CheckBox)
        If Not IsNothing(lblChk) Then
            lblChk.Checked = e.Row.DataItem("chk")
        End If
        '*** message ***'
    ...
    Private Sub SetCboBranch()
        ...
        cboBranch.DataSource = branch.List
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        For i = 0 To rows - 1
            ...
            Dim chkSelect As CheckBox = DirectCast(row.FindControl("lblChk"), CheckBox)
            Dim remindid As Label = CType(row.FindControl("lblid"), Label)
            Dim reminddate As Date = Convert.ToDateTime(txtDueDate.Text)
