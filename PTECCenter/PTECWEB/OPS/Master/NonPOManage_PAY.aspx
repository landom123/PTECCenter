<%@ Page Title="จัดการงาน (PAY)" Language="vb" AutoEventWireup="false" MasterPageFile="~/site.Master" CodeBehind="NonPOManage_PAY.aspx.vb" Inherits="PTECCENTER.NonPOManage_PAY" %>
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12 mb-3">
                        <div class="input-group sm-3">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="btn btn-sm  btn-secondary" onclick="find('../Master/NonPOManage_PAY.aspx?NonpoCode=','ระบุเลขที่เอกสาร')">Find</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        <div class="input-group">
                            ...
                            <asp:Button ID="btnSave" class="btn btn-success btn-sm" runat="server" Text="Save" OnClientClick="Confirm()" AutoPostBack="false" UseSubmitBehavior="false" />
                        </div>
                    </div>
                </div>
                <hr />
                <div class="row notPrint" id="card_attatch" runat="server">
                    ...
                    <div class="col-lg-6 mb-3" id="card_comment" runat="server">
