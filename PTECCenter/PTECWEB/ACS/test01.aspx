<%@ Page Title="" Language="vb" AutoEventWireup="false" 
    MasterPageFile="~/site.Master" CodeBehind="test01.aspx.vb" Inherits="PTECCENTER.test01" %>
            ...
            <div class="container-fluid">    
                ...
                <ol class="breadcrumb"style="background-color:deeppink;color:white">
                  <li class="breadcrumb-item" >
                           <i class="fa fa-tasks" aria-hidden="true"></i> ทดสอบเรียกตารางค่าใช้จ่าย ตามสัญญา
                  </li>
                </ol>
                <p></p>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="input-group sm-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text">ยอดขาย</span>
                          </div>
