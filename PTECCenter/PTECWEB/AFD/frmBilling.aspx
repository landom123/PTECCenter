<%@ Page Title="Budget" Language="vb" AutoEventWireup="false" MasterPageFile="~/site.Master" CodeBehind="frmBilling.aspx.vb" Inherits="PTECCENTER.frmBilling" %>
            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">E-tax ใบแจ้งหนี้ (Billing)</a>
                    </li>
                </ol>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <asp:Button ID="btnSearch" class="btn btn-sm d-none btn-success" runat="server" Text="Search" UseSubmitBehavior="false" />&nbsp;   
