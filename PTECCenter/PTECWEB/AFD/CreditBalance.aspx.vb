...
Public Class CreditBalance
    ...
    Private Sub SetComboCreateDate()
        Dim acc As New Account
        listDate.DataSource = acc.Credit_List_DateOfData
        listDate.DataValueField = "createdate"
        listDate.DataBind()
    End Sub
    ...
    Private Sub WHTax353_4_Init(sender As Object, e As EventArgs) Handles Me.Init
        If Not (Session("creditbalance") Is Nothing) Then
            'Session("rpt353") = rpt
            Me.CrystalReportViewer1.ReportSource = Session("creditbalance")
    ...
    Protected Sub btnView_Click(sender As Object, e As EventArgs) Handles btnView.Click
        Dim rpt As New ReportDocument()
        Dim login As New GlobalClass
        Dim rptname = "~\afd\rpt\CustomerCreditBalance.rpt"
        Dim createdate As String = listDate.Text
        ...
        rpt.SetParameterValue("@date", createdate)
        'rpt.SetParameterValue("@monthly", monthly)
        'rpt.SetParameterValue("@taxtype", taxtype)
        'rpt.SetParameterValue("@doctype", doctype)

        Session("creditbalance") = rpt
        Me.CrystalReportViewer1.ReportSource = Session("creditbalance")
        Me.CrystalReportViewer1.DataBind()
    End Sub
End Class