<%@ Page Title="KPIsSummary2Person" Language="vb" AutoEventWireup="true" MasterPageFile="~/site.Master" CodeBehind="KPIsSummary2Person.aspx.vb" Inherits="PTECCENTER.KPIsSummary2Person" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col  align-self-center  font-weight-bold">
                            (ผลประเมินของ <span class="text-warning">พนักงาน</span> + <span class="text-success">หัวหน้างาน</span>)
                        </div>
                            ...
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="competency__main  mb-5" id="cardcompetency" runat="server">
                                        <div class="row">
                                            <div class="col font-weight-bold">
                                                <span>สรุปหัวข้อการพัฒนา Training Need (พนักงาน)
                                                </span>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="competencyApprover__main  mb-5" id="Div2" runat="server">
                                        <div class="row">
                                            <div class="col font-weight-bold">
                                                <span>สรุปหัวข้อการพัฒนา Training Need (หัวหน้างาน)
                                                </span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mx-3 bg-light p-2 text-muted font-italic">
                                                    <asp:Label ID="txtTrainingApprover" runat="server" Text="-" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
