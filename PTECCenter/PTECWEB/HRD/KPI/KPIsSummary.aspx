                                            ...
                                            <div id="collapse__<%= formsTable.Rows(j).Item("KPIForm_ID").ToString() %>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-sm-12 col-md-auto">
                                                            <a href="./test"><i class="fas fa-cog"></i>&nbsp;แก้ไขแบบฟอร์ม (Admin)</a>
                                                        </div>
                                                        <div class="col-sm-12 col-md-auto">
                                                            <button class="btn btn-link btn-block text-left p-0" type="button" onclick="return deleteForms(<%= formsTable.Rows(j).Item("KPIForm_ID").ToString() %>);">
            ...
            if (formid > 0) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var params = "{'formid': '" + formid + "','message': '" + result.value + "','updateby': '" + usercode + "'}";
                        console.log(params);
                        $.ajax({
                            type: "POST",
