...
Public Class EssoPDFBrowse
    ...
    Private Sub SaveToSQL()
        ...
        For Each row As DataRow In potable.Rows
            ...
            End If
            po.POSave(row.Item("SH_REQUESTED_DELIVERY_DATE"), row.Item("SH_CUSTOMER_NO"), row.Item("SH_SHIP_TO_PARTY"),
                  row.Item("SH_PO_NO"), vehicleid, row.Item("SH_PLANT"), usercode, poFileName)
        Next
