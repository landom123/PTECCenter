<%@ Page Title="" Language="vb" AutoEventWireup="false" 
    MasterPageFile="~/site.Master" CodeBehind="EssotoLoadconfirmList.aspx.vb" Inherits="PTECCENTER.EssotoLoadconfirmList" %>
            ...
            <div class="container-fluid">    
                ...
                <ol class="breadcrumb"style="background-color:deeppink;color:white">
                  <li class="breadcrumb-item" >
                           <i class="fa fa-tasks" aria-hidden="true"></i> Esso EDI to D365
                  </li>
                </ol>
                <p></p>
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="input-group sm-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text">วันที่ Load น้ำมัน</span>
                          </div>
                          ...
                          <div class="card-body">
<%--                    <div class="col-12 text-right">
                            <asp:Button ID="btnselectall" class="btn btn-sm  btn-danger" runat="server" Text="Select All" />  
                    </div>--%>
