<%@ Page Title="" Language="vb" AutoEventWireup="false" 
    MasterPageFile="~/site.Master" CodeBehind="EssoInvoicetoD365.aspx.vb" Inherits="PTECCENTER.EssoInvoicetoD365" %>
                                    ...
                                    <AlternatingRowStyle BackColor="#CCCCFF" />
                                      ...
                                      <Columns>
	                                    <asp:TemplateField HeaderText="Ship From">
		                                    <ItemTemplate>
			                                    <asp:Label id="lblshipfrom" runat="server" Text='<%#Eval("terminal")%>'></asp:Label>
		                                    </ItemTemplate>
	                                    </asp:TemplateField>
