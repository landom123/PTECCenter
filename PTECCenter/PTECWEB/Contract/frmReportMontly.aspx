                                                        ...
                                                        <asp:Table ID="tblData" class="table table-bordered table-condensed table-hover pnlstudentDetails" style='font-family:Tahoma, Courier, monospace; font-size:8pt;' 
                                                                runat="server" GridLines="Both" cellspacing="0" cellpadding="5" border="1" OnPageIndexChanging="OnPageIndexChanging" PageSize="10">
                                                                    <asp:TableHeaderRow TableSection="TableHeader" runat="server">
                                                                        ...
                                                                        <asp:TableHeaderCell ColumnSpan="3" style='margin:0 auto; text-align:center; background-color:mediumslateblue; width :auto;' runat="server">Period</asp:TableHeaderCell>
                                                                        ...
                                                                        <asp:TableHeaderCell ColumnSpan="1" RowSpan="2" style='margin:0 auto; text-align:center; background-color:mediumaquamarine; width :auto;' runat="server">สั่งจ่ายเช็ค</asp:TableHeaderCell>
