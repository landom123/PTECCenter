...
Partial Class Rpt_Customer_bal_all_Branch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'asdate = "20211111"
        'branch = "003"
        SetReportParameters(asdate)


    End Sub
    Private Sub SetReportParameters(asdate As String)
        'Set Processing Mode
        ...
        ReportViewer1.ServerReport.ReportPath =
           "/GSM/rpt_customer_bal_all_Branch"
        ...
        Response.AddHeader("content-disposition", "attachment; filename=ArBal" & "_" & asdate & "." + extension)
